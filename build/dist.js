...
var _toConsumableArray2 = __webpack_require__(153);
                ...
                return _regenerator2.default.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                return _context.abrupt("return", this.eventHandlers[event] && (_eventHandlers = this.eventHandlers)[event].apply(_eventHandlers, (0, _toConsumableArray3.default)(args)));
...
var History = function (_Base) {
    (0, _inherits3.default)(History, _Base);

    function History() {
        var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
        (0, _classCallCheck3.default)(this, History);

        var _this = (0, _possibleConstructorReturn3.default)(this, (History.__proto__ || (0, _getPrototypeOf2.default)(History)).call(this, config));
...
var _shell2 = __webpack_require__(152);

var _shell3 = _interopRequireDefault(_shell2);

var _pathhandler = __webpack_require__(166);
...
var _readline = __webpack_require__(154);

var _readline2 = _interopRequireDefault(_readline);

var _stream = __webpack_require__(157);
...
var _clear = __webpack_require__(158);

var _clear2 = _interopRequireDefault(_clear);

var _help = __webpack_require__(159);

var _help2 = _interopRequireDefault(_help);

var _history3 = __webpack_require__(160);

var _history4 = _interopRequireDefault(_history3);

var _grep = __webpack_require__(161);

var _grep2 = _interopRequireDefault(_grep);

var _echo = __webpack_require__(162);
...
var _head = __webpack_require__(164);

var _head2 = _interopRequireDefault(_head);

var _default = __webpack_require__(165);
...
var Shell = function (_Base) {
    (0, _inherits3.default)(Shell, _Base);

    function Shell(config, terminal) {
        (0, _classCallCheck3.default)(this, Shell);

        var _this = (0, _possibleConstructorReturn3.default)(this, (Shell.__proto__ || (0, _getPrototypeOf2.default)(Shell)).call(this, config));
    ...
    (0, _createClass3.default)(Shell, [{
        ...
        value: function () {
            var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(cmdline) {
        ...
        value: function _load() {
            ...
            this.readline.on("enter", function () {
                var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(cmdtext) {
                    var promises;
                    return _regenerator2.default.wrap(function _callee2$(_context2) {
                        while (1) {
                            switch (_context2.prev = _context2.next) {
            ...
            this.readline.on("cancel", (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3() {
...
var _killring = __webpack_require__(155);
...
var ReadLine = function (_Base) {
    (0, _inherits3.default)(ReadLine, _Base);

    function ReadLine() {
        var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
        (0, _classCallCheck3.default)(this, ReadLine);

        var _this = (0, _possibleConstructorReturn3.default)(this, (ReadLine.__proto__ || (0, _getPrototypeOf2.default)(ReadLine)).call(this, config));
    ...
    (0, _createClass3.default)(ReadLine, [{
        key: "isActive",
        value: function isActive() {
            return this.active;
        }
...
var KillRing = function (_Base) {
    (0, _inherits3.default)(KillRing, _Base);

    function KillRing() {
        var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
        (0, _classCallCheck3.default)(this, KillRing);

        var _this = (0, _possibleConstructorReturn3.default)(this, (KillRing.__proto__ || (0, _getPrototypeOf2.default)(KillRing)).call(this, config));
    ...
    (0, _createClass3.default)(KillRing, [{
        key: "isinkill",
...
var Stream = function (_Base) {
    (0, _inherits3.default)(Stream, _Base);
    ...
    function Stream() {
        ...
        var _this2 = (0, _possibleConstructorReturn3.default)(this, (Stream.__proto__ || (0, _getPrototypeOf2.default)(Stream)).call(this));
...
exports.default = {
    desc: "Clear output",
    exec: function () {
        var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(term /* , streams, cmd, opts, args */) {
            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
...
exports.default = {
    ...
    completion: function () {
        var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(term, cmd, name, value) {
            return _regenerator2.default.wrap(function _callee2$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
...
var _cd = __webpack_require__(167);

var _cd2 = _interopRequireDefault(_cd);

var _ls = __webpack_require__(168);

var _ls2 = _interopRequireDefault(_ls);

var _pwd = __webpack_require__(169);
...
var PathHandler = function (_Base) {
    (0, _inherits3.default)(PathHandler, _Base);

    function PathHandler(config, shell) {
        (0, _classCallCheck3.default)(this, PathHandler);

        var _this = (0, _possibleConstructorReturn3.default)(this, (PathHandler.__proto__ || (0, _getPrototypeOf2.default)(PathHandler)).call(this, config));
    ...
    (0, _createClass3.default)(PathHandler, [{
        key: "getNode",
        value: function () {
        ...
        value: function () {
            var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(cmd, arg /* , line */) {
        ...
        value: function () {
            var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(node, partial) {
                var childNodes;
                return _regenerator2.default.wrap(function _callee4$(_context4) {
                    while (1) {
                        switch (_context4.prev = _context4.next) {
